import { c as createLucideIcon, R as React2, b as useComposedRefs, j as jsxRuntimeExports, r as reactExports, d as reactDomExports, e as cn, f as useSearch, g as useNavigate, X, B as Button, h as Badge, a as LoadingGrid } from "./index-H678KSt5.js";
import { E as EmptyState } from "./EmptyState-Ck0uGg5A.js";
import { u as useProducts, P as ProductCard } from "./useProducts-CcNXd3HP.js";
import { c as createContextScope, a as createSlot, P as Primitive, u as useLayoutEffect2, b as useControllableState, d as composeEventHandlers } from "./index-B7w5Djay.js";
import { u as useCallbackRef, a as useId, P as Portal$1, h as hideOthers, b as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer } from "./Combination-DLafyM7a.js";
import { u as useSize, a as usePrevious } from "./index-rOxqgYq2.js";
...
function Products() {
  ...
  const [priceRange, setPriceRange] = reactExports.useState([0, 500]);
  ...
  const filters = {
    ...
    maxPrice: priceRange[1] < 500 ? priceRange[1] : void 0
  };
  ...
  const hasActiveFilters = !!searchQuery || !!categoryParam || priceRange[0] > 0 || priceRange[1] < 500;
  const selectedCategory = categories == null ? void 0 : categories.find(
    (c) => String(c.id) === categoryParam
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-b border-border/50 sticky top-0 z-30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              "Filters",
              hasActiveFilters && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-primary" })
            ]
          }
        ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showFilters && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-3 pb-1 grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Category" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  value: categoryParam ?? "all",
                  onValueChange: (val) => updateSearch({
                    category: val === "all" ? void 0 : val
                  }),
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      SelectTrigger,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                      ...
                      categories == null ? void 0 : categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: String(cat.id), children: [
                        cat.name,
                        " (",
                        cat.count,
                        ")"
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Price range" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-5", children: [
      searchQuery && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          !isLoading && products && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: products.length === PER_PAGE ? `${PER_PAGE}+ products found` : `${products.length} product${products.length !== 1 ? "s" : ""} found` })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            variant: "ghost",
            size: "sm",
            onClick: () => updateSearch({ search: void 0 }),
      ...
      selectedCategory && !searchQuery && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-sm py-1 px-3", children: selectedCategory.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => updateSearch({ category: void 0 }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs text-muted-foreground mb-4 sm:hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "inline h-3 w-3 mr-1" }),
      ...
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingGrid, { count: PER_PAGE, cols: 4 }) : isError ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        EmptyState,
        {
          ...
          description: hasActiveFilters ? "Try adjusting your filters or search terms." : "No products are available right now.",
          ctaLabel: hasActiveFilters ? "Clear filters" : void 0,
          onCta: hasActiveFilters ? clearFilters : void 0
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
